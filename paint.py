...
class Paint(Frame):
    ...
    def setUI(self):
        ...
        gray_btn = Button(self, text="Gray", width=10,
                            command=lambda: self.set_color("gray"))
        gray_btn.grid(row=0, column=4)
        ...
        fourth_btn = Button(self, text="Nineteen", width=10,
                           command=lambda: self.set_brush_size(19))
        fourth_btn.grid(row=1, column=4)
